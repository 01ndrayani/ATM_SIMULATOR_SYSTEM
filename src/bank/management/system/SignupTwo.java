...
{
    JLabel additionalDetails,name, sname, dob,pincode, gender,city,state, email,address, marital;
    JButton next;
    JTextField pantxtfld,adhtxtfld;
    
    ButtonGroup sctzn, ectzn;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        {
           Conn c = new Conn();
           String query = "insert into signuptwo values('"+formno+"','"+sreligion+"','"+scategory+"','"+sincome+"','"+seducation+"','"+soccupation+"','"+pan+"','"+adhar+"','"+snct+"','"+extacct+"')"; 
